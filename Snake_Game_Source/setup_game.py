...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Peter Stengl"
        self.author_email = "peter@5stengl.de"
        self.copyright = "Copyright (c) 2016 Peter Setngl."
 
        #Description
        self.project_description = "This is a Snake Game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['Content']
